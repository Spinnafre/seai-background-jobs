...
describe("# Send Newsletter", () => {
  test("When has news should be able to send newsletter emails", async () => {
    ...
    const dbNews = [
      {
        ...
        Description: "test",
        Data: [
          100, 97, 116, 97, 58, 116, 101, 120, 116, 47, 104, 116, 109, 108, 59,
          99, 104, 97, 114, 115, 101, 116, 61, 117, 116, 102, 45, 56, 59, 98,
          97, 115, 101, 54, 52, 44, 67, 105, 65, 103, 73, 67, 65, 56, 97, 68,
          69, 43, 77, 49, 89, 122, 73, 70, 86, 83, 84, 68, 119, 118, 97, 68, 69,
          43, 67, 105, 65, 103, 73, 67, 65, 56, 89, 83, 66, 111, 99, 109, 86,
          109, 80, 87, 104, 48, 100, 72, 65, 54, 76, 121, 57, 122, 98, 50, 90,
          48, 100, 50, 70, 121, 90, 83, 52, 122, 100, 106, 77, 117, 90, 109, 70,
          121, 98, 84, 53, 87, 97, 88, 78, 112, 100, 71, 85, 103, 89, 83, 66,
          122, 98, 50, 90, 48, 100, 50, 70, 121, 90, 84, 119, 118, 89, 84, 52,
          75,
        ],
        CreatedAt: new Date(),
        UpdatedAt: new Date(),
    ...
    expect(sendEmailServiceWatch).toBeCalledWith({
      host: MAILER_TRANSPORT_CONFIG.host,
      port: MAILER_TRANSPORT_CONFIG.port,
      username: MAILER_TRANSPORT_CONFIG.auth.user,
      password: MAILER_TRANSPORT_CONFIG.auth.pass,
      from: MAILER_OPTIONS.from,
      to: `test1@gmail.com,${MAILER_OPTIONS.to}`,
      subject: "NEWSLETTER",
